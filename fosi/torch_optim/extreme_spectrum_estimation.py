...
def get_ese_fn(loss_fn, k_largest, batch=None, l_smallest=0, return_precision='32', device=torch.device("cuda"), precondition_world_size=None ,worker_world_size = None, group = None, rank = None):
    ...
    lanczos_alg_gitted = lanczos_alg(lanczos_order, loss_fn, k_largest, l_smallest, return_precision=return_precision, device=device,  precondition_world_size=precondition_world_size ,worker_world_size = worker_world_size, group = group, rank = rank)
